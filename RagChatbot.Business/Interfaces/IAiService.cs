...
namespace RagChatbot.Business.Interfaces
{
    public interface IAiService
    {
        ...
        Task<string> GetChatResponseAsync(string systemPrompt, string userMessage, IEnumerable<RagChatbot.Business.DTOs.ChatMessageDto>? history = null, CancellationToken cancellationToken = default);
